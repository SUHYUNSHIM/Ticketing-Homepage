...
<form action="Seat_main.jsp" method= "get">
...
<!-- <button type="button" onclick="window.open('Seat_main.jsp','name','resizable=no width=1100 height=615');return false">예매하기 -->
<button type="submit" name="예매하기" onclick="window.open('Seat_main.jsp','name','resizable=no width=1100 height=615');return false"></button>
</form>
